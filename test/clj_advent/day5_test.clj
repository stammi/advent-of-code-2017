...
(deftest day5-star1
  (testing "the examples"
    (let [start {:stepno       0
      ...
      (let [step1 (step std-update-fn start)]
        (is (= {:stepno       1
                :position     0
                :instructions [1 3 0 1 -3]} step1))
        (let [step2 (step std-update-fn step1)]
          (is (= {:stepno       2
                  :position     1
                  :instructions [2 3 0 1 -3]} step2))
          (let [step3 (step std-update-fn step2)]
            (is (= {:stepno       3
                    :position     4
                    :instructions [2 4 0 1 -3]} step3))
            (let [step4 (step std-update-fn step3)]
              (is (= {:stepno       4
                      :position     1
...
(deftest day5-star2
  (testing "the thing"
    (is (= 28040648 (walk-maze strange-update-fn input)))))