...
(defn step [{:keys [position instructions stepno]}]
  (let [new-position (+ position (get instructions position))]
    (if (or (> 0 new-position)
      ...
      {:stepno         (inc stepno)
       ...
       :instructions (update instructions (or position 0) inc)})))
...
(deftest day5-star1
  (testing "the examples"
    ...
    (testing "the thing"
      (is (= 387096
             (loop [{:keys [stepno position instructions finished?] :as i} input]
